...
#endif
static const char *ng0 = "C:/Users/10791/co_P7/P7_code/ExecuteReg.v";
...
LAB41:    memcpy(t153, t115, 8);

LAB42:    memset(t96, 0, 8);
    t185 = (t153 + 4);
...
LAB65:    memcpy(t95, t201, 8);

LAB66:    t202 = (t0 + 3984);
    xsi_vlogvar_wait_assign_value(t202, t95, 0, 0, 32, 0LL);
...
LAB48:    if (*((unsigned int *)t146) != 0)
        goto LAB49;

LAB50:    t154 = *((unsigned int *)t115);
...
LAB62:    xsi_vlog_unsigned_bit_combine(t95, 32, t196, 32, t201, 32);
    goto LAB66;

LAB64:    memcpy(t95, t196, 8);
    goto LAB66;
...
extern void work_m_00000000000125655479_4190013900_init()
{
	static char *pe[] = {(void *)Always_56_0};
	xsi_register_didat("work_m_00000000000125655479_4190013900", "isim/mips_txt_isim_beh.exe.sim/work/m_00000000000125655479_4190013900.didat");
